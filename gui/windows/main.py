...
from utils import GetLogoIcon, GetIcon
...
class App(QWidget):
    ...
    def createMainPage(self):
        ...
        # 创建标题
        self.titleLabel = MinecraftTitle("我的世界音乐包生成器")
        ...
        self.editorBtn = MinecraftPixelButton("音乐包编辑器", button_type="blue")
        self.editorBtn.setMinimumSize(150, 40)
        self.editorBtn.clicked.connect(self.onOpenEditor)
        
        # 添加按钮到水平布局
        self.buttonLayout.addWidget(self.createProjectBtn)
        self.buttonLayout.addWidget(self.openProjectBtn)
        self.buttonLayout.addWidget(self.editorBtn)
    ...
    def onOpenEditor(self):
        """打开音乐包编辑器按钮点击事件"""
        from gui.windows.editor_window import EditorWindow
